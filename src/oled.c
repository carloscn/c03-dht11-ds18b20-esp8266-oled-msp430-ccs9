...
void oled_write_command(OLED *dev,unsigned char i2c_command) {
    ...
    dev->hw.i2c->write(dev->hw.i2c, 0x78);     //slave address, SA0 = 0;
    dev->hw.i2c->waitack(dev->hw.i2c);
    dev->hw.i2c->write(dev->hw.i2c, 0x00);     //write i2c_command
    dev->hw.i2c->waitack(dev->hw.i2c);
...
void oled_write_data(OLED *dev,unsigned char i2c_data) {
    ...
    dev->hw.i2c->write(dev->hw.i2c, 0x78);     //slave address, SA0 = 0;
    dev->hw.i2c->waitack(dev->hw.i2c);
    dev->hw.i2c->write(dev->hw.i2c, 0x40);     //write data
    dev->hw.i2c->waitack(dev->hw.i2c);
